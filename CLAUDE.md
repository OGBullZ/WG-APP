...
- **Tests:** `geld.mjs` 40 Checks über die echte Oberfläche, Gegenprobe `scratchpad/gegenprobe-geld.mjs` 24 Sabotagen rot. 🪤 Lokal liegen die Listen als **Array**, die Map-Form (`{id: {...}}`) ist die Firebase-Seite — im Test immer über die `id` suchen, sonst prüft man `undefined === undefined`.
